...
<body>
    ...
    <p class="nota">
        Los promedios se calculan con precisión completa y se expresan con un decimal truncado únicamente al presentarse. El promedio final de grado asigna el mismo peso a los cuatro campos formativos.
    </p>
</body>
</html>
