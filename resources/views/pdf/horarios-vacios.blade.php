...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .line-1 { margin-top: 16px; }
        .line-2 { margin-top: 13px; }
        .field-label {
            font-size: 7px;
            color: #64748b;
            font-weight: 700;
        ...
        .field-label.profesor { margin-top: 9px; }
        .footer-note {
            margin-top: 8px;
            font-size: 8px;
            color: #64748b;
                ...
                <table class="header-table">
                    <tr>
                        ...
                        <td class="title-block">
                            ...
                            <div class="subtitle">Ciclo escolar {{ $cicloEscolar->inicio_anio }} - {{ $cicloEscolar->fin_anio }}</div>
                        </td>
                        <td class="logo-cell">
                            @if ($logoDerecho)
