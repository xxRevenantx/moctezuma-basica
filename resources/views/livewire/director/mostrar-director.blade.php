<div x-data="{
    ...
    <div class="flex flex-col gap-1">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
            Busca, edita o elimina personal directivo.
        </p>
    </div>
    ...
    <div
        ...
        <div class="p-4 sm:p-5 lg:p-6">
            <div class="flex flex-col gap-3 lg:gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="w-full sm:max-w-xl">
                    ...
                    <flux:input id="buscar-directivo" type="text" wire:model.live="search"
        ...
        <div class="px-4 pb-4 sm:px-5 sm:pb-6 lg:px-6">
            <div class="relative">
                ...
                <!-- Loader -->
                <div wire:loading.delay wire:target="search, eliminarDirectivo"
                                    ...
                                    @else
                                        @foreach ($directivos as $key => $directivo)
                                            ...
                                            <tr
                                                ...
                                                <td class="px-4 py-3 text-center text-gray-800 dark:text-gray-200">
                                                    <div class="flex items-center justify-center gap-2">
                                                        <button type="button"
                                                            ...
                                                            @click="openRow === {{ $directivo->id }} ? openRow = null : openRow = {{ $directivo->id }}"
                                                            :aria-expanded="openRow === {{ $directivo->id }}"
                                                            aria-label="Ver más datos del directivo">
                                                            <!-- + -->
                                                            <svg x-show="openRow !== {{ $directivo->id }}"
                                                            ...
                                                            <!-- x -->
                                                            <svg x-show="openRow === {{ $directivo->id }}" x-cloak
                                                                xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                                                                viewBox="0 0 20 20" fill="currentColor">
                                                                <path fill-rule="evenodd"
                                                ...
                                                <td class="px-4 py-3 text-gray-900 dark:text-white">
                                                    {{ $directivo->nombre }}
                                                    {{ $directivo->apellido_paterno }}
                                                    {{ $directivo->apellido_materno }}
                                                </td>
                                                <td class="px-4 py-3 text-gray-800 dark:text-gray-200">
                                                    {{ $directivo->cargo ?: '---' }}
                                                </td>
                                                <td class="px-4 py-3 text-center">
                                                    @if ($directivo->status == 1)
                                                        <span
                                                    ...
                                                    <div class="flex items-center justify-center gap-2">
                                                        <flux:button variant="primary"
                                                            ...
                                                            @click="$dispatch('abrir-modal-editar');
                                                                Livewire.dispatch('editarModal', { id: {{ $directivo->id }} });
                                                            ">
                                                        ...
                                                        <flux:button variant="danger"
                                                            ...
                                                            @click="eliminar({{ $directivo->id }}, '{{ $directivo->nombre }}')">
                                            ...
                                            <tr x-show="openRow === {{ $directivo->id }}" x-cloak
                                    ...
                                    <div class="flex items-start justify-between gap-3">
                                        ...
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <flux:button variant="primary"
                                                class="cursor-pointer bg-amber-500 hover:bg-amber-600 text-white"
                                                @click="$dispatch('abrir-modal-editar');
                                                                Livewire.dispatch('editarModal', { id: {{ $d->id }} });
                                                            ">
                                                <flux:icon.square-pen class="w-3.5 h-3.5" />
                                                <!-- ícono -->
                                            </flux:button>
        ...
        <!-- Modal editar -->
        <livewire:director.editar-director />
    </div>
</div>
