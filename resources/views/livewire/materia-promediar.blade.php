                ...
                <div
                    ...
                    @if ($this->esBachillerato)
                        <div class="space-y-2">
                            <flux:field>
                                ...
                                <flux:select wire:model.live="promediar_semestre_id"
                                    :disabled="blank($promediar_grado_id)">
                                    <option value="">Selecciona un semestre</option>
                                    @foreach ($promediar_semestres as $item)
                                        <option value="{{ $item['id'] }}">
                                            {{ $item['numero'] ?? ($item['semestre'] ?? ($item['nombre'] ?? 'Semestre ' . $item['id'])) }}
                                            @if (isset($item['numero']) && filled($item['numero']))
                                                ° semestre
                                            @endif
                                        </option>
                                    @endforeach
                    ...
                    <div class="space-y-2">
                        <flux:field>
                            ...
                            <flux:select wire:model.live="promediar_grupo_id"
                                :disabled="$this->esBachillerato ? (blank($promediar_grado_id) || blank($promediar_semestre_id)) : blank($promediar_grado_id)">
