<div x-data="{
    ...
    <form wire:submit.prevent="guardarMateriasPromediar" class="relative">
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Configura el grado y la cantidad de materias a considerar para el promedio.
                    </p>
                </div>
        ...
        <div wire:loading.flex wire:target="guardarMateriasPromediar,promediar_grado_id,promediar_semestre_id"
                            ...
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <h4 class="mt-1 text-base font-black text-slate-800 dark:text-white">
                                        {{ $item->grado?->nombre ?? '—' }}
                                        @if ($this->esBachillerato && $item->semestre?->numero)
                                            · {{ $item->semestre->numero }}° semestre
                                        @endif
                                    </h4>
                                </div>
