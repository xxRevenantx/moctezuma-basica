<div x-data="{ show: false, loading: false }" x-cloak x-trap.noscroll="show" x-show="show"
  ...
  "
    ...
    <div class="relative w-[92vw] sm:w-[88vw] md:w-[90vw] max-w-2xl mx-4 sm:mx-6
        bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl ring-1 ring-black/5 dark:ring-white/10 overflow-hidden
        ...
        <!-- Header -->
        <div
            class="px-5 sm:px-6 pt-4 flex items-start justify-between gap-3 sticky top-0
            bg-white/95 dark:bg-neutral-900/95 backdrop-blur z-10">
            <div class="min-w-0">
                <h2 id="titulo-modal-periodo" class="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white">
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-400">
                    <span class="inline-flex items-center gap-2">
                        <flux:badge color="indigo">
                            Ciclo escolar: {{ $inicio_anio ?? '—' }} – {{ $fin_anio ?? '—' }}
                        </flux:badge>
                    </span>
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div
                        ...
                        <div class="mt-1 text-sm text-zinc-700 dark:text-zinc-200">
                            El año final debe ser mayor o igual al año de inicio y normalmente es +1.
                        </div>
                    </div>
