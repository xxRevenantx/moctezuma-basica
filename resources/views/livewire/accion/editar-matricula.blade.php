<div x-data="{ cargandoPagina: true }" x-init="setTimeout(() => cargandoPagina = false, 700)" class="space-y-6">
                ...
                <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <span
                            ...
                            Matrícula protegida según selección
                        </span>
    ...
    "
                            class="group inline-flex cursor-pointer items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white/80 px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-0.5 hover:border-sky-200 hover:bg-sky-50 hover:text-sky-700 hover:shadow-lg hover:shadow-sky-500/10 dark:border-neutral-700 dark:bg-neutral-800/80 dark:text-slate-200 dark:hover:border-sky-800 dark:hover:bg-sky-950/30 dark:hover:text-sky-300">
                            <span
