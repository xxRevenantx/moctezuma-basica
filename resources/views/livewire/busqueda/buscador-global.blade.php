...
<div
    ...
    x-on:buscador-global-cerrado.window="cerrando = false"
...
>
    @if (auth()->user()?->is_admin && $modalAbierto)
        <div
            x-ref="modalBusquedaGlobal"
            x-init="enfocar()"
            data-buscador-global-modal
        ...
        <div x-transition.opacity.duration.150ms
            class="absolute inset-0 bg-slate-950/55 backdrop-blur-sm" x-on:click="solicitarCierre()"></div>
                                            ...
                                            <button type="button"
                                                ...
                                                <span class="mt-2.5 grid size-5 shrink-0 place-items-center">
                                                    ...
                                                    <span wire:loading.flex
                                                        wire:target="seleccionar({{ $resultado['indice'] }})"
                                                        class="items-center justify-center" aria-label="Abriendo resultado">
        ...
        <div x-cloak x-show="cerrando" x-transition.opacity.duration.150ms
            ...
            <div
                ...
                <svg class="size-5 animate-spin text-[#006492] dark:text-sky-300" viewBox="0 0 24 24" fill="none">
                    <circle cx="12" cy="12" r="9" stroke="currentColor" stroke-opacity=".2"
                        stroke-width="3"></circle>
                    <path d="M21 12a9 9 0 0 1-9 9" stroke="currentColor" stroke-width="3"
                        stroke-linecap="round"></path>
