            ...
            <div x-cloak x-show="abierto === 'credenciales'" x-transition:enter="transition ease-out duration-300"
                ...
                <div
                    ...
                    <div wire:loading.flex
                        wire:target="generacion_id,grado_id,semestre_id,grupo_id,modo_descarga,buscar_alumno,alumno_individual_id,alumnos_seleccionados,limpiarFiltros,seleccionarTodosVisibles,limpiarSeleccion"
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        @if ($modo_descarga === 'seleccionados')
                            <div
                                class="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs font-semibold text-slate-500 dark:text-slate-400">
                                            Marca los alumnos que deseas incluir en el PDF de credenciales.
                                        </p>
                                    </div>
