...
class EditarMatricula extends Component
{
    ...
    public function updatedCurp(string $value): void
    {
        ...
        $this->pais_nacimiento = data_get($payload, 'response.Solicitante.Nacionalidad') ?: $this->pais_nacimiento;
        $this->estado_nacimiento = data_get($payload, 'response.Solicitante.EntidadNacimiento') ?: $this->estado_nacimiento;
        $this->lugar_nacimiento = data_get($payload, 'response.Solicitante.EntidadNacimiento') ?: $this->lugar_nacimiento;
    ...
    public function editarModal($id): void
    {
        ...
        $this->fecha_nacimiento = $inscripcion->fecha_nacimiento
            ? \Carbon\Carbon::parse($inscripcion->fecha_nacimiento)->format('Y-m-d')
            : null;
